...
pub mod thread_map {
  ...
  impl <_T :Server> ServerDispatch<_T> {
    pub fn dispatch_call_internal(server: &mut _T, method_id: u16, params: ::capnp::capability::Params<::capnp::any_pointer::Owned>, results: ::capnp::capability::Results<::capnp::any_pointer::Owned>) -> ::capnp::capability::Promise<(), ::capnp::Error> {
      match method_id {
        0 => server.make_thread(::capnp::private::capability::internal_get_typed_params(params), ::capnp::private::capability::internal_get_typed_results(results)),
        _ => { ::capnp::capability::Promise::err(::capnp::Error::unimplemented("Method not implemented.".to_string())) }
      }
    }
  }
  ...
  pub mod make_thread_params {
    ...
    mod _private {
      pub static ENCODED_NODE: [::capnp::Word; 35] = [
        ...
        ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
        ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
        ::capnp::word(109, 112, 47, 112, 114, 111, 120, 121),
        ::capnp::word(46, 99, 97, 112, 110, 112, 58, 84),
        ::capnp::word(104, 114, 101, 97, 100, 77, 97, 112),
        ::capnp::word(46, 109, 97, 107, 101, 84, 104, 114),
...
pub mod thread {
  ...
  impl <_T :Server> ServerDispatch<_T> {
    pub fn dispatch_call_internal(server: &mut _T, method_id: u16, params: ::capnp::capability::Params<::capnp::any_pointer::Owned>, results: ::capnp::capability::Results<::capnp::any_pointer::Owned>) -> ::capnp::capability::Promise<(), ::capnp::Error> {
      match method_id {
        0 => server.get_name(::capnp::private::capability::internal_get_typed_params(params), ::capnp::private::capability::internal_get_typed_results(results)),
        _ => { ::capnp::capability::Promise::err(::capnp::Error::unimplemented("Method not implemented.".to_string())) }
      }
    }
  }
  ...
  pub mod get_name_params {
    ...
    mod _private {
      pub static ENCODED_NODE: [::capnp::Word; 18] = [
        ...
        ::capnp::word(109, 112, 47, 112, 114, 111, 120, 121),
        ::capnp::word(46, 99, 97, 112, 110, 112, 58, 84),
        ::capnp::word(104, 114, 101, 97, 100, 46, 103, 101),
        ::capnp::word(116, 78, 97, 109, 101, 36, 80, 97),
  ...
  pub mod get_name_results {
    ...
    mod _private {
      pub static ENCODED_NODE: [::capnp::Word; 34] = [
        ...
        ::capnp::word(46, 99, 97, 112, 110, 112, 58, 84),
        ::capnp::word(104, 114, 101, 97, 100, 46, 103, 101),
        ::capnp::word(116, 78, 97, 109, 101, 36, 82, 101),
...
pub mod context {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 57] = [
      ...
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(233, 8, 0, 0, 111, 10, 0, 0),
      ...
      ::capnp::word(111, 110, 116, 101, 120, 116, 0, 0),
